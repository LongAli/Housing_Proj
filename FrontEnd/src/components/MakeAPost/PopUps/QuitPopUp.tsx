...
const QuitPopUp: FunctionComponent<QuitPopUpProps> = ({
  ...
  <Modal
    ...
    modalGraphic={MakeAPost.QuitPost}
  >
    ...
    <div className={styles.supportText}>
      {' '}
      All information in the session will be lose after refresh.
    </div>
    <div className={cn(styles.failPopUpBottom, styles.modalBottomWrapper)}>
      <Button className={styles.modalButton} onClick={onClose}>
        <Subtitle2>Cancel</Subtitle2>
      </Button>
      <Button variant="outline" className={styles.modalButton} onClick={() => {onQuit(); onClose();}}>
